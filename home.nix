...

{
  ...
  home.shellAliases = {
    ...
    ruc = "sudo nix flake update --flake ~/nixos && sudo nixos-rebuild switch --flake ~/nixos#QUASAR && sudo nix-env -p /nix/var/nix/profiles/system --delete-generations +3 && sudo nix-collect-garbage && sudo nixos-rebuild boot --flake ~/nixos#QUASAR";
  };
